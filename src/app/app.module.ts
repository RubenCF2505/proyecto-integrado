...
@NgModule({
  ...
  imports: [BrowserModule, AppRoutingModule, TabMenuModule, ProgressBarModule, ToastModule, MatSidenavModule, MatProgressBarModule, CarouselModule, ReactiveFormsModule,MatCheckboxModule,MatInputModule,BrowserAnimationsModule,MatSelectModule],
  providers: [],

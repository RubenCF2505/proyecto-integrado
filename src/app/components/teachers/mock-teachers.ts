...
export const TEACHERS: Teacher[] = [
    ...
    },
    {
        id: 5,
        name: 'Gohan',
        description: ' Gohan, con sus experiencias diversas, desde batallas intensas hasta búsquedas académicas, sería un profesor excepcional. Su actitud tranquila y paciente crearía un entorno de aprendizaje positivo, explicando conceptos complejos de manera sencilla. Además, compartiría historias increíbles sobre salvar el mundo y entrenar con guerreros poderosos. ¡Imagina la emoción de tener a un Saiyan como tu profesor!',
        classes:"Gohan lideraría clases en técnicas avanzadas de artes marciales, física o incluso historia intergaláctica. Sus clases no solo serían educativas, sino también impregnadas de experiencias del mundo real. Los estudiantes saldrían no solo con conocimientos, sino también inspirados y con una comprensión más profunda del mundo.    ",
        index: "assets/images/bola.png",
